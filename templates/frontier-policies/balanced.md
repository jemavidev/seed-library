...
uncompensated ones escalate to expert review. Per-tool overrides are allowed in both
directions but must be recorded with a reason, so the policy stays legible.
