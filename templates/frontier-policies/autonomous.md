...
below `confirm` for uncompensated external effects can even be expressed. Adopt it only where
compensations are tested and checkpoints proven, and pair it with budget-threshold alerts so
autonomy stays bounded by spend, not just by stance.
